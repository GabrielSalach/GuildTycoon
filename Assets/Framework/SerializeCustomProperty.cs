...
using UnityEditor;
    ...
    public class SerializeCustomProperty : PropertyAttribute
    {
        public string PropertyName { get; private set; }
 
        public SerializeCustomProperty(string propertyName)
        {
    ...
    #if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(SerializeCustomProperty))]
    public class SerializeCustomPropertyAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (propertyFieldInfo == null)
                propertyFieldInfo = target.GetType().GetProperty(((SerializeCustomProperty)attribute).PropertyName,
